...
- Open **Settings** to configure appearance, including theme presets, per-mode palette/font controls, and an optional chat background image, plus provider binary overrides, Kimi API key storage, and model preferences.
