...
- `/apps/server`: Node.js WebSocket server. Wraps the Codex app server and GitHub Copilot CLI runtime, serves the built web app, and opens the browser on start.
