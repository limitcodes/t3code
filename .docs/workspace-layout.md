...
- `/apps/server`: Node.js HTTP/WebSocket server. Serves the built web app, owns orchestration/project/git/terminal APIs, and routes provider sessions for Codex, GitHub Copilot, and Kimi Code.
